      ...
      <div className={styles.headerDesktop}>
        ...
        <nav className={styles.headerNav}>
          ...
          >
            ...
            <span style={{ paddingLeft: 6 }}>{t("menuItemHome")}</span>
          </Link>
          <Link
          ...
          >
            ...
            <span style={{ paddingLeft: 6 }}>{t("menuItemMyBookshelf")}</span>
          </Link>
          <Link
          ...
          >
            ...
            <span style={{ paddingLeft: 6 }}>{t("menuItemAskQuestion")}</span>
          </Link>
          <Link
          ...
          >
            ...
            <span style={{ paddingLeft: 6 }}>{t("menuItemSearch")}</span>
          </Link>
        </nav>
        <div style={{ display: "flex", alignItems: "center" }}>
